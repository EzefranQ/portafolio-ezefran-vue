<template>
    <div >
        ...
        <section class="sm:mt-10 mt-6 ml-2 leading-7 md:text-base text-sm textColor">
            <p>Soy un desarrollador
                <!-- web con dos años de experiencia en el campo. Tengo conocimientos en HTML, CSS, Bootstrap, Tailwind, Vue, EJS y JavaScript. Tengo conocimientos de las últimas tecnologías web y siempre estoy al día de los últimos desarrollos. -->
            </p>
                <br><br>
