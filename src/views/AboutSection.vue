<template>
    <div >
        ...
        <section class="mt-10 grid lg:grid-cols-2 grid-cols-1 place-items-center gap-y-8 gap-x-5 md:text-base text-sm">
            <article v-for="article in articles" :key="article.id" class="max-h-80 max-w-2xl flex md:flex-row flex-col md:items-start items-center md:text-start text-center gap-5 borderStyle sm:p-6 p-2 py-6">
                <div class="w-auto h-auto md:translate-y-5" :class="article.tailMargin">     
